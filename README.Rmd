...
- **Ward**: level with base R and SciPy, as expected, since all three run the
  same nearest-neighbour-chain algorithm; the difference is the Rust distance
  computation feeding it. Above 10,000 points only shoal is run, at 20,000 the
