...
- **Ward**: 1.8 to 2 times faster than base R and 1.3 to 1.4 times faster
  than SciPy. All three run the same nearest-neighbour-chain algorithm, so the
  differences are in computing the distances that feed it. Runs stop at
  20,000 points, where the distance matrix alone is 1.6 GB.
